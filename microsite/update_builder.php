...
if(mysqli_query($con,"update overview set builder_logo='".$location."',last_update='".$lastup."' where proj_id='$_POST[id]'") or die( mysqli_error($con)))
{
echo "Upload done";
mysqli_query($con,"update pdetail set fimage='".$location."' where ftitle='logo' and pcode='$_POST[id]'") or die( mysqli_error($con));
}
else
{
