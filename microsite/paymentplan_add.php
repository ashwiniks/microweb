...
$Detail= mysqli_real_escape_string($con,$_POST['paymentplan_details']);
$Updatequery = mysqli_query($con,"Update overview set paymentplan_details='".$Detail."',last_update='".$lastup."' where proj_id='".$Proj_Id."'")
