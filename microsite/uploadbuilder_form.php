...
<div class="form_heading">Upload new or Update Builder Logo</div>

<div class="form_field_countuner">

<form name="updatelogo" id="contact" action="update_builder.php" method="post" enctype="multipart/form-data">
<?php 
$Proj_Id=$_GET['id'];
?>
<table>
...
<div class="form_name">Upload Builder Image(Less than 1mb Size)</div>
