...
<div class="form_heading">Upload</div>
<div class="form_field_countuner">

<form name="updatelogo" id="contact" action="brochures_upload.php" method="post" enctype="multipart/form-data">
<?php 
$Proj_Id=$_GET['id'];
?>
<table>
...
<!--<a href="javascript: closepopup(mithi)">Close </a> -->
<?php
mysqli_close($con);
?>
</body>
