...
if(mysqli_query($con,"update overview set file_name='".$location."',last_update='".$lastup."' where proj_id='$_POST[id]'") or die( mysqli_error($con)))
{
echo "Upload done!";
mysqli_query($con,"update pdetail set fimage='".$location."' where ftitle='image' and pcode='$_POST[id]'") or die( mysqli_error($con));
}
else
{
