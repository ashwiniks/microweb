...
<form name="updatelogo" id="contact" action="feature_imgupload.php" method="post" enctype="multipart/form-data">
<?php 
$Proj_Id=$_GET['id'];
?>
<table>
...
<div class="form_name">Upload Logo image(Less than 1mb Size)</div>
