...
<script type="text/javascript">setTimeout("window.close();", 600000);</script>
</head>
<body>
<title>Image</title>
<br />
...
<div class="form_heading">Upload Location Map</div>
<div class="form_field_countuner">

<form name="updatelogo" id="contact" action="locationmap_upload.php" method="post" enctype="multipart/form-data">
<?php 
$Proj_Id=$_GET['id'];
?>
<table>
...
<div class="form_name">Upload Image(Less than 1mb Size)</div>
