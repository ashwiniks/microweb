...
<div class="form_heading">Upload Site Plan</div>
<div class="form_field_countuner">

<form name="updatelogo" id="contact" action="siteplan_upload.php" method="post" enctype="multipart/form-data">
<?php 
$Proj_Id=$_GET['id'];
?>
<table>
...
<div class="form_name">Upload Image(Less than 2mb Size)</div>
