...
<div class="logoarea_main"><a href="#" title="Awadh Grand Tower"><img src="projectimages/<?php //$row['file_name']; ?>" width="319" height="43" alt="agt" /></a></div>

<div class="logoarea_infra"><a href="#" title="Nortern Realty Infra Pvt. Ltd."><img src="projectimages/<?php //$row['builder_logo']; ?>" width="274" height="74" alt="infra logo" /></a></div>
...
<div class="call"> <img src="images/phone-icon.png" width="41" height="50" alt="phone icon" align="center" /><span style="color:#006; font-weight:bold;">Call Now:</span> <?php //$row['cont_number']; ?>&nbsp;&nbsp;<img src="images/email-icon.png" width="41" height="50" alt="phone icon" align="center" />&nbsp;&nbsp;<span style="color:#006; font-weight:bold;">Email:</span> <?php //$row['cont_email']; ?></div>
